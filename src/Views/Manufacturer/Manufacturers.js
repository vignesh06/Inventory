      ...
      <Container>
        <br />  <Row>
          <Col md={12} lg={12} sm={12} xs={12}>
            <span><h2>Manufacturers</h2> </span>             <span><Button variant="primary" style={{"float":"right"}} onClick={()=>props.history.push("/admin/createmanufacturer")} size="md" >Create Manufacturer</Button></span>    &nbsp;&nbsp;&nbsp;
